//
//  NavigationManagerFramework.h
//  NavigationManagerFramework
//
...
//! Project version number for NavigationManagerFramework.
FOUNDATION_EXPORT double NavigationManagerFrameworkVersionNumber;
